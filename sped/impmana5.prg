...
WHILE ! EOF()
   MDS(Cnpj)
   aDADOS:={cnpjxml->CNPJ,cnpjxml->IE,cnpjxml->IMUNICIPAL,cnpjxml->UF,cnpjxml->CIDADE,cnpjxml->NOME,"CNPJXML",TIRAOUT(cnpjxml->CEP),cnpjxml->DDD, ;
            cnpjxml->SUFRAMA,cnpjxml->CNAE,cnpjxml->EMAIL,cnpjxml->TELEFONE }        
   gravacert(aDADOS)
   DBSELECTAR("CNPJXML")   
   DBSKIP()
ENDDO
